...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>Lotus Book operates strictly as an educational sports insights and analytics platform, encouraging responsible play. We advise all users to verify their local state regulations before participating in real-money transactions.</p>
    `
  },
  {
    slug: "lotusbook-book-login-guide-2025",
    title: "Lotus Book Login Guide 2025 – Secure Access",
    excerpt: "Step-by-step guide to logging into your Lotus Book account safely and quickly.",
    ...
    content: `
      ...
      <p>Input your unique Lotus Book ID username and the password provided during registration. We recommend changing your initial password immediately after your first login for security.</p>
  ...
  },
  {
    ...
    title: "India vs Australia ODI Series 2025: Play Smart",
    ...
    readTime: "6 min read",
    content: `
      <p>The upcoming bilateral ODI series between India and Australia promises high-octane action and excellent gaming opportunities. Our team of cricket experts has analyzed the team sheets, pitch conditions, and historical head-to-head stats to help you play smart.</p>
      ...
      <p>Log into your Lotus Book ID to access live odds, in-play statistics, and instant play slips for every ball of the series.</p>
    `
  }
];
