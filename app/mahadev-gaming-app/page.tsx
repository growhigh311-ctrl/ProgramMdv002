...
const appFeatures = [
  { title: "Live Gaming Exchange", desc: "Play on cricket, football, tennis and kabaddi while the action unfolds in real-time." },
...
const installSteps = [
  ...
  { num: "4", title: "Log In & Play", desc: "Open the app, sign in using your verified Mahadev Book ID, and start playing." }
];
