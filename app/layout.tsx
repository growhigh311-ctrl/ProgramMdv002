...
const BASE_URL = "https://mahadevreal.site";
...
export const metadata: Metadata = {
  ...
  title: {
    default: "Mahadev Book Official Website | ID & Account Information Guide",
  ...
  verification: {
    google: "y6dTdhcQjnE1OhAO05-wDoZFwJwj_PCo0c-hDNYjve8",
  },
  openGraph: {
...
export default function RootLayout({
  ...
  const schemaCode = {
    ...
    "@graph": [
      ...
      {
        "@type": "Organization",
        "@id": "https://mahadevreal.site/#organization",
        "name": "Mahadev Book",
        "url": "https://mahadevreal.site/"
      },
      {
    ...
    >
      <head>
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify(schemaCode) }}
        />
      </head>
